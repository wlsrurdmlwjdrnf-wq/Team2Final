...
public class UIManager : Singleton<UIManager>
{
    ...
    [SerializeField] private SlotUI _equippedWeaponSlot;
    [SerializeField] private SlotUI _equippedAccessorySlot;
    ...
    private List<SlotUI> _skillSlots = new List<SlotUI>();
    ...
    private void HandleEvent(EGameEventType type, object payload)
    {
        ...
        switch (type)
        {
            case EGameEventType.SlotUpdated:
                ...
                {
                    var slotUIs = _weaponContent.GetComponentsInChildren<SlotUI>(true);
                    slotUIs = slotUIs.Concat(_accessoryContent.GetComponentsInChildren<SlotUI>(true)).ToArray();
                    slotUIs = slotUIs.Concat(_skillContent.GetComponentsInChildren<SlotUI>(true)).ToArray();
    ...
    public void Initialize()
    {
        ...
        {
            SlotUI slotUI = PoolManager.Instance.GetFromPool(_slotUIPrefab);
    ...
    {
        foreach (SlotUI slotUI in _skillSlots) slotUI.ReturnPool();
